...
<title><?php
  ...
  ================================================== -->
	...
	<!-- Favicons
	================================================== -->
	<link rel="shortcut icon" href="http://crossfitomnia.com/favicon.ico" type="image/x-icon">
              ...
              <div class="topBarSocial">
                ...
                <ul class="topBarSocialList">
                  ...
                  <?php if ( ot_get_option( 'top_bar_social_twitter', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_twitter' ); ?>"><span class="social-icon-twitter"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_facebook', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_facebook' ); ?>"><span class="social-icon-facebook"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_vimeo', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_vimeo' ); ?>"><span class="social-icon-vimeo"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_googleplus', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_googleplus' ); ?>"><span class="social-icon-gplus"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_pinterest', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_pinterest' ); ?>"><span class="social-icon-pinterest"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_flickr', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_flickr' ); ?>"><span class="social-icon-flickr"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_linkedin', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_linkedin' ); ?>"><span class="social-icon-linkedin"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_dribbble', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_dribbble' ); ?>"><span class="social-icon-dribbble"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_instagram', '' ) != '' ) : ?>
                    <li><a target="_blank" href="<?php echo ot_get_option( 'top_bar_social_instagram' ); ?>"><span class="social-icon-instagram"></span></a></li>
                  <?php endif; ?>

                  <?php if ( ot_get_option( 'top_bar_social_behance', '' ) != '' ) : ?>
                    <li><a target="_blank"href="<?php echo ot_get_option( 'top_bar_social_behance' ); ?>"><span class="social-icon-behance"></span></a></li>
                  <?php endif; ?>
